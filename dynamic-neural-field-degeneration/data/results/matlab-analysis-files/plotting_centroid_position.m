%% Plot the evolution of centroid position as a function of the degeneration percentage
...
experiments = {%'deactivate weights', 'weight', numberOfWeights, numberOfWeightsDegeneratedPerIteration, 0.0; ...
               'reduce 0.05 weights', 'weight', numberOfWeights, numberOfWeightsDegeneratedPerIteration, 0.0; ... 
               %'randomize weights', 'weight', numberOfWeights, numberOfWeightsDegeneratedPerIteration, 0.0; ...
...
positions = { %'2.0'; '6.0'; '10.0'; '14.0'; '18.0'; '22.0';
    '26.0'};  
targetCentroids = { % 2.0 ; 6.0; 10.0; 14.0; 18.0; 22.0; 
    26.00};

centroidsFilePath = '';
analysisFilePath = '';
plotFilePath = './plots/5-random-centroid-evolution-as-degeneration-occurs/';
...
for experiment = 1:size(experiments,1)
    for position = 1:size(positions,1)
        ...
        %data = select_data_plots(data);
        data = select_data_plots_evolution(data, targetCentroid);
        ...
        plot_centroid_evolution(data, plotFilePath, title, subTitle, targetCentroid, acceptableDeviation, numberOfElementsTotal, numberOfElementsDegeneratedPerIteration);
    end
end