...
centroidsFilePath = '';
analysisFilePath = '';
plotFilePath = './plots/average-deviation-all-trials/';
...
for experiment = 1:size(experiments,1)
    for position = 1:size(positions,1)
        ...
        plot_centroid_avg_deviation(deviations, plotFilePath, title, subTitle, targetCentroid, acceptableDeviation, numberOfElementsTotal, numberOfElementsDegeneratedPerIteration);
    end
end