function plotDeviation(lines, locationDirPath, figTitle, subTitle, acceptableDeviation)
...
acceptableRange = [0, acceptableDeviation];
...
valid_title = regexprep(figTitle, '[^\w\s]', '');
