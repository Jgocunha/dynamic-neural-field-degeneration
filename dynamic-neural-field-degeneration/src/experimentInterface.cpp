#include "../include/experimentInterface.h"
...
void ExperimentWindow::renderShapeDetails()
{
	...
	ImGui::Text("Decision field centroid is %.2f", expWinParams.robotTargetAngle);
}
...
{
	expWinParams.robotTargetAngle = robotTargetAngle;
}
