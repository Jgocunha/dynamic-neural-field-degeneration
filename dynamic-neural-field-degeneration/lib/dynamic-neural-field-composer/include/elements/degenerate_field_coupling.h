...
public:
	DegenerateFieldCoupling(const std::string& id, const uint8_t& sizeOfOutputField, const uint8_t& sizeOfInputField, const FieldCouplingParameters& parameters, const LearningRule& learningRule);
