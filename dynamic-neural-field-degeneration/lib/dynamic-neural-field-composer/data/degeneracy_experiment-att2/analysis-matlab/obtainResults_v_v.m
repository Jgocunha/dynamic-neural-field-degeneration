...
%% Setup variables
experiments = {
               'NEURONS_DEACTIVATE_field v_field v', 'neurons', 'iteration'; ...
               'NEURONS_DEACTIVATE_PERCENTAGE_field v_field v', 'neurons', 'percentage'; ...
               };
    ...
    for location = 1:size(locations,1)
        ...
        switch experiments{experiment, 1}
            case 'NEURONS_DEACTIVATE_field v_field v'
                ...
                subTitle = 'Output field analysis';
            case 'NEURONS_DEACTIVATE_PERCENTAGE_field v_field v'
